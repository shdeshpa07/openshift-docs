...
+
xref:../security/external_secrets_operator/external-secrets-operator-release-notes.adoc#external-secrets-operator-release-notes[{external-secrets-operator}]
