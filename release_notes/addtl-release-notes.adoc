...
Release notes for additional related components and products not included in the core xref:../release_notes/ocp-4-20-release-notes.adoc#ocp-4-20-release-notes[{product-title} {product-version} release notes] are available in the following documentation.
...
+
link:https://docs.redhat.com/en/documentation/red_hat_openshift_distributed_tracing_platform/latest/html/release_notes_for_the_distributed_tracing_platform/distr-tracing-rn[{DTProductName}]
+
...
+
xref:../virt/release_notes/virt-4-20-release-notes.adoc#virt-4-20-release-notes[Red Hat {VirtProductName}]
+
link:https://docs.redhat.com/en/documentation/red_hat_build_of_opentelemetry/latest/html-single/release_notes_for_the_red_hat_build_of_opentelemetry/index[{OTELName}]
