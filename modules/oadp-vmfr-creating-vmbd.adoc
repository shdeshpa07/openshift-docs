...
[role="_abstract"]
Create a `VirtualMachineBackupsDiscovery` (VMBD) custom resource (CR) to identify which Velero backups contain a specified virtual machine. This helps you to locate available backups before performing a file-level restore.
