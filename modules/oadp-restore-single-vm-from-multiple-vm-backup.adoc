...
spec:
  ...
  LabelSelectors:
    ...
    - matchLabels:
        app: <vm_name> # <2>
----
<1> Specify the UID of the `DataVolume` of the VM that is to be restored. For example, `b6...53a-ddd7-4d9d-9407-a0c...e5`.
