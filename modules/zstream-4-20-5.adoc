...
= RHBA-2025:21811 - {product-title} {product-version}.5 fixed issues advisory

Issued: 25 November 2025

[role="_abstract"]
{product-title} release {product-version}.5 is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2025:21811[RHBA-2025:21811] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:21809[RHBA-2025:21809] advisory.
