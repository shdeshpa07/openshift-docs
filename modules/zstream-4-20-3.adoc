...
= RHSA-2025:19890 - {product-title} {product-version}.3 image release, fixed issues, and security update advisory

Issued: 11 November 2025

[role="_abstract"]
{product-title} release {product-version}.3, which includes security updates, is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:19890[RHSA-2025:19890] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:19888[RHBA-2025:19888] advisory.
