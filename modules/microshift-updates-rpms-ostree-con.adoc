...
The procedures are the same for minor-version and patch updates. For example, use the same steps to upgrade from 4.19 to 4.20 or from 4.20.2 to 4.20.3. The following details apply:
