...
= RHBA-2026:23120 - {product-title} {product-version}.46 fixed issues

Issued: 06 January 2026

[role="_abstract"]
{product-title} release {product-version}.46 is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2026:23120[RHBA-2026:23120] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:23118[RHBA-2025:23118] advisory.
