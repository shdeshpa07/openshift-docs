...
= Example: Performing a backup with OADP and {product-title}

[role="_abstract"]
Perform a backup by using {oadp-first} with {product-title}. The following example `hello-world` application has no persistent volumes (PVs) attached.
