...
= RHSA-2026:2672 - {product-title} {product-version}.49 fixed issues

Issued: 18 February 2026

[role="_abstract"]
{product-title} release {product-version}.49 is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2026:2672[RHBA-2026:2672] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2026:2670[RHSA-2026:2670] advisory.
