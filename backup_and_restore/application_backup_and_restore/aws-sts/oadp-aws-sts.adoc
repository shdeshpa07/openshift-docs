...
To install the OADP Operator in a restricted network environment, you must first disable the default OperatorHub sources and mirror the Operator catalog. See _Using Operator Lifecycle Manager on restricted networks_ for details.
