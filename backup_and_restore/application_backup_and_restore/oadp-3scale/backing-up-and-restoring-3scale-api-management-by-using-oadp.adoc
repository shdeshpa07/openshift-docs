...
= Backing up and restoring 3scale API Management by using OpenShift API for Data Protection (OADP)
...
You can deploy 3scale components on premises, in the cloud, as a managed service, or in any combination based on your requirements.
