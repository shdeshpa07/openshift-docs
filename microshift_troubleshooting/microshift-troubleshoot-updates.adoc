...
* xref:../microshift_updating/microshift-update-options.adoc#microshift-rhde-compatibility-table_microshift-update-options[{op-system-bundle} release compatibility matrix]
